...
class NewsActivity : AppCompatActivity() {
    ...
    private fun observe() {
        ...
        viewModel.recentNewsResult.observe(this) { result ->
            when (result) {
        ...
        viewModel.resulturlRecentNewsResult.observe(this) { result ->
            when (result) {
        ...
        viewModel.commentnumberResult.observe(this) { result ->
            when (result) {
